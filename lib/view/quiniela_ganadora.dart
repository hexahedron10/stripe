...
class Quinielaganadora extends StatefulWidget {
  const Quinielaganadora({Key? key}) : super(key: key);
  @override
  State<Quinielaganadora> createState() => _QuinielaganadoraState();
}

class _QuinielaganadoraState extends State<Quinielaganadora> {
...
//juega con el valor local empate visita    value! indica que no puede ser nulo
  ...
  Future<void> insertaresultado(BuildContext context) async {
    ...
    try {
      String uri = "${GlobalVariables().host}captura_quiniela_ganadora.php";
...
//inserta la jornada
      ...
      if (token != null) {
        ...
        print('tu base de datos no tiene token');
        // El token no está disponible, maneja el caso en consecuencia
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Captura Quiniela Ganadora"),
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  Row(
                    children: [
                      ...
                      /*Text('quinielaganadora: ${userdata[index]['selectedOption']}'),*/
                    ],
                  );*/
                },
              ),
