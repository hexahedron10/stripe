...
import 'package:app_q/controller/ganadores.dart';
import '../drawer/drawer.dart';
import '../view/colores_plantilla.dart';
import 'package:flutter_secure_storage/flutter_secure_storage.dart';

class JornadaGanadores extends StatefulWidget {
  const JornadaGanadores({super.key});
  @override
  State<JornadaGanadores> createState() => _JornadaGanadoresState();
}

class _JornadaGanadoresState extends State<JornadaGanadores> {
...
// obtengo el token de la funcion obtenerToken guardado en el dispositivo
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text("Ganadores Jornada"),
